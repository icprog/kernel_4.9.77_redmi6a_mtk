...
#define TI_CPU_EXCP 32 /* offsetof(struct thread_info, cpu_excp)	// */
#define TI_REGS_ON_EXCP 24 /* offsetof(struct thread_info, regs_on_excp)	// */

#define THREAD_CPU_CONTEXT 2592 /* offsetof(struct task_struct, thread.cpu_context)	// */
